...
@section('content')
    <div class="fs-1 fw-bold my-5">Update User</div>
        ...
        <div class="row ">
            <div class="col-md-8 p-3 border border-secondary-subtle">
                ...
                <div class="row form-group d-flex justify-content-center">
                    ...
                    <div class="col-md-9 ">
                        <input type="text" name="name" id="name" class="p-2 w-100 border-secondary-subtle" value="{{ $user->name }}">
                    </div>
                ...
                <div class="row form-group d-flex justify-content-center mt-4">
                    ...
                    <div class="col-md-9 ">
                        <input type="email" name="email" class="p-2 w-100 border-secondary-subtle" value="{{ $user->email }}">
                    </div>
                ...
                <div class="row  my-5">
                    <div class="col-sm-12 text-right d-flex justify-content-end">
                        <button type="submit" class="btn bg-btn mx-4">Update</button>
